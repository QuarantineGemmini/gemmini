...
//===========================================================================
class DMAReqTrackerEntry[T <: Data](val config: GemminiArrayConfig[T])
...
//===========================================================================
// DMAReqTracker Interfaces
//===========================================================================
class DMAReqIncr[T <: Data](val config: GemminiArrayConfig[T])
  (implicit p: Parameters) extends CoreBundle {
  import config._
...
// DMAReqTracker 
//===========================================================================
class DMAReqTracker[T <: Data](config: GemminiArrayConfig[T])
  ...
  val io = IO(new Bundle {
    ...
    val incr  = Flipped(Valid(new DMAReqIncr(config)))
  ...
  //----------------------------------
  val entries = Reg(Vec(DMA_REQS, UDValid(new DMAReqTrackerEntry(config))))
  when (reset.toBool()) {
